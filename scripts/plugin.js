            ...
            return this.each(function () {
                ...
                if (!_showFlag) {
                    ...
                    $.each(_countries, function (i, country) {
                        $(`<option class="countries" value="${country[_codeProp]}"> ${country[NAME]} </option>`)
                    ...
                    let _$selector = $("<div class=\"cs-selector\" tabindex=\"0\"><span class=\"cs-flag-selected cs-flag XXX\"></span><span class=\"cs-name-selected\"></span><span class=\"cs-arrow\"></span></div>")
                        .insertAfter(_$this),
                        _$list = $("<ul class=\"cs-list\" style=\"display: none;\"></ul>")
                            .insertAfter(_$selector);

                    function ensureVisible($li) {
                        let scrollTop = _$list.scrollTop(),
                            top = $li.position().top,
                        ...
                        //This adds the flag and name?

                    function select($li) {
                        let country = $li.data("country");
                    ...
                    function move(direction) {
                        let $selected = _$list.children("li.cs-selected"),
                            $nextSelected = null;
                    ...
                    function showList() {
                        let position = _$selector.position(),
                            left = position.left,
                    ...
                    // Makes keyboard commands and focus state work
                    _$selector
                        .on("focus click", showList)
                        .blur(function () {
                            // use timer to ensure click event in dropdown list is triggered
                        ...
                        //When selected, makes the options disappear only displaying chosen country
